...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 28 22:56:48 2020
...
class TransformerModelClassifier(nn.Module):

    def __init__(self, ntoken, ninp, nhead, nhid, nlayers, n_classes, dropout=0.5):
        super(TransformerModelClassifier, self).__init__()
        from torch.nn import TransformerEncoder, TransformerEncoderLayer
        self.model_type = 'Transformer'
        self.src_mask = None
        self.pos_encoder = PositionalEncoding(ninp, dropout)
...
#        self.classifier = nn.Linear(ntoken, n_classes)
        self.relu = nn.ReLU()
